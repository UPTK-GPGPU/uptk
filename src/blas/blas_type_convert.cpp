...
extern "C"
{
    ...
    cudaDataType UPTKDataTypeTocudaDataType(UPTKDataType para)
    {
           switch (para)
    {
        case UPTK_R_16F: return CUDA_R_16F;
        case UPTK_C_16F: return CUDA_C_16F;
        case UPTK_R_16BF: return CUDA_R_16BF;
        case UPTK_C_16BF: return CUDA_C_16BF;
        case UPTK_R_32F: return CUDA_R_32F;
        case UPTK_C_32F: return CUDA_C_32F;
        case UPTK_R_64F: return CUDA_R_64F;
        case UPTK_C_64F: return CUDA_C_64F;
        case UPTK_R_4I: return CUDA_R_4I;
        case UPTK_C_4I: return CUDA_C_4I;
        case UPTK_R_4U: return CUDA_R_4U;
        case UPTK_C_4U: return CUDA_C_4U;
        case UPTK_R_8I: return CUDA_R_8I;
        case UPTK_C_8I: return CUDA_C_8I;
        case UPTK_R_8U: return CUDA_R_8U;
        case UPTK_C_8U: return CUDA_C_8U;
        case UPTK_R_16I: return CUDA_R_16I;
        case UPTK_C_16I: return CUDA_C_16I;
        case UPTK_R_16U: return CUDA_R_16U;
        case UPTK_C_16U: return CUDA_C_16U;
        case UPTK_R_32I: return CUDA_R_32I;
        case UPTK_C_32I: return CUDA_C_32I;
        case UPTK_R_32U: return CUDA_R_32U;
        case UPTK_C_32U: return CUDA_C_32U;
        case UPTK_R_64I: return CUDA_R_64I;
        case UPTK_C_64I: return CUDA_C_64I;
        case UPTK_R_64U: return CUDA_R_64U;
        case UPTK_C_64U: return CUDA_C_64U;
        case UPTK_R_8F_E4M3: return CUDA_R_8F_E4M3;
        case UPTK_R_8F_E5M2: return CUDA_R_8F_E5M2;
        default:
            ERROR_INVALID_ENUM();
        }
    }
    ...
    UPTKDataType hipDataTypeTocudaDataType(cudaDataType para)
    {
        switch (para)
        {
 case CUDA_R_16F: return UPTK_R_16F;
        case CUDA_C_16F: return UPTK_C_16F;

        case CUDA_R_16BF: return UPTK_R_16BF;
        case CUDA_C_16BF: return UPTK_C_16BF;

        case CUDA_R_32F: return UPTK_R_32F;
        case CUDA_C_32F: return UPTK_C_32F;

        case CUDA_R_64F: return UPTK_R_64F;
        case CUDA_C_64F: return UPTK_C_64F;

        case CUDA_R_4I: return UPTK_R_4I;
        case CUDA_C_4I: return UPTK_C_4I;

        case CUDA_R_4U: return UPTK_R_4U;
        case CUDA_C_4U: return UPTK_C_4U;

        case CUDA_R_8I: return UPTK_R_8I;
        case CUDA_C_8I: return UPTK_C_8I;

        case CUDA_R_8U: return UPTK_R_8U;
        case CUDA_C_8U: return UPTK_C_8U;

        case CUDA_R_16I: return UPTK_R_16I;
        case CUDA_C_16I: return UPTK_C_16I;

        case CUDA_R_16U: return UPTK_R_16U;
        case CUDA_C_16U: return UPTK_C_16U;

        case CUDA_R_32I: return UPTK_R_32I;
        case CUDA_C_32I: return UPTK_C_32I;

        case CUDA_R_32U: return UPTK_R_32U;
        case CUDA_C_32U: return UPTK_C_32U;

        case CUDA_R_64I: return UPTK_R_64I;
        case CUDA_C_64I: return UPTK_C_64I;

        case CUDA_R_64U: return UPTK_R_64U;
        case CUDA_C_64U: return UPTK_C_64U;

        case CUDA_R_8F_E4M3: return UPTK_R_8F_E4M3;
        case CUDA_R_8F_E5M2: return UPTK_R_8F_E5M2;
        default:
            ERROR_INVALID_ENUM();
        }
    }
